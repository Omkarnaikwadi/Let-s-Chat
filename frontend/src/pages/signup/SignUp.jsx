...
const SignUp = () => {
	...
	return (
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto rounded-lg border border-gray-600'>
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-500 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0'>
				<h1 className='text-3xl font-bold text-center text-gray-600'>
					Sign Up <span className='text-gray-800 font-bold'> ChatApp</span>
				</h1>
